      ...
      (Q.prototype = {
          ...
          if (
            ...
            if (t) i = this.$menuInner[0].scrollTop;
              ...
              if ("number" == typeof n && !1 !== P.options.size) {
                ...
                r &&
                  (i =
                    r - (P.sizeInfo.menuInnerHeight + P.sizeInfo.liHeight) / 2);
              }
            }
          function l(e, t) {
            var i,
              ...
              f = !0,
              m = P.isVirtual();
            (P.selectpicker.view.scrollTop = e),
              (i = Math.ceil(
                (P.sizeInfo.menuInnerHeight / P.sizeInfo.liHeight) * 1.5
              )),
              (s = Math.round(p / i) || 1);
            for (var v = 0; v < s; v++) {
              var g = (v + 1) * i;
              ...
              void 0 === r &&
                e - 1 <=
                  P.selectpicker.current.data[g - 1].position -
                    P.sizeInfo.menuInnerHeight &&
                (r = v);
            }
            if (
              (void 0 === r && (r = 0),
              (l = [
                P.selectpicker.view.position0,
                P.selectpicker.view.position1,
              ]),
              (n = Math.max(0, r - 1)),
              (o = Math.min(s - 1, r + 1)),
              (P.selectpicker.view.position0 =
              ...
              (a =
                l[0] !== P.selectpicker.view.position0 ||
                l[1] !== P.selectpicker.view.position1),
              void 0 !== P.activeIndex &&
                ((H = P.selectpicker.main.elements[P.prevActiveIndex]),
                (W = P.selectpicker.main.elements[P.activeIndex]),
                (D = P.selectpicker.main.elements[P.selectedIndex]),
                t &&
                  (P.activeIndex !== P.selectedIndex && P.defocusItem(W),
                  (P.activeIndex = void 0)),
                P.activeIndex &&
                  P.activeIndex !== P.selectedIndex &&
                  P.defocusItem(D)),
              void 0 !== P.prevActiveIndex &&
                P.prevActiveIndex !== P.activeIndex &&
                P.prevActiveIndex !== P.selectedIndex &&
                P.defocusItem(H),
              (t || a) &&
                ((c = P.selectpicker.view.visibleElements
                  ? P.selectpicker.view.visibleElements.slice()
                  : []),
                (P.selectpicker.view.visibleElements =
                  !1 === m
                    ? P.selectpicker.current.elements
                    : P.selectpicker.current.elements.slice(
                        P.selectpicker.view.position0,
                        P.selectpicker.view.position1
                      )),
                P.setOptionStatus(),
                (N || (!1 === m && t)) &&
                  ((d = c),
                  (h = P.selectpicker.view.visibleElements),
                  (f = !(
                    d.length === h.length &&
              ...
              for (var S = $.length; v < S; v++) {
                ...
                P.options.sanitize &&
                  (E = O.lastChild) &&
                  (C =
                    P.selectpicker.current.data[
                      v + P.selectpicker.view.position0
                    ]) &&
                  C.content &&
                  !C.sanitized &&
              ...
              if (
                (P.options.sanitize &&
                  y.length &&
                  B(y, P.options.whiteList, P.options.sanitizeFn),
                (I.firstChild.style.marginBottom =
                  !0 === m
                    ? ((b =
                        0 === P.selectpicker.view.position0
                          ? 0
                          : P.selectpicker.current.data[
                              P.selectpicker.view.position0 - 1
                            ].position),
                      (w =
                        P.selectpicker.view.position1 > p - 1
                          ? 0
                          : P.selectpicker.current.data[p - 1].position -
                            P.selectpicker.current.data[
                              P.selectpicker.view.position1 - 1
                            ].position),
                      (I.firstChild.style.marginTop = b + "px"),
                      w + "px")
                    : (I.firstChild.style.marginTop = 0)),
                I.firstChild.appendChild(x),
                !0 === m && P.sizeInfo.hasScrollBar)
              ) {
                var z = I.firstChild.offsetWidth;
                if (
                  t &&
                  z < P.sizeInfo.menuInnerInnerWidth &&
                  P.sizeInfo.totalMenuWidth > P.sizeInfo.selectWidth
                )
                  I.firstChild.style.minWidth =
                    P.sizeInfo.menuInnerInnerWidth + "px";
                else if (z > P.sizeInfo.menuInnerInnerWidth) {
                  P.$menu[0].style.minWidth = 0;
                  var T = I.firstChild.offsetWidth;
                  T > P.sizeInfo.menuInnerInnerWidth &&
                    ((P.sizeInfo.menuInnerInnerWidth = T),
                    (I.firstChild.style.minWidth =
                      P.sizeInfo.menuInnerInnerWidth + "px")),
                    (P.$menu[0].style.minWidth = "");
                }
              }
            }
            if (((P.prevActiveIndex = P.activeIndex), P.options.liveSearch)) {
              if (N && t) {
                var A,
                  L = 0;
                P.selectpicker.view.canHighlight[L] ||
                  (L =
                    1 + P.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                  (A = P.selectpicker.view.visibleElements[L]),
                  P.defocusItem(P.selectpicker.view.currentActive),
                  (P.activeIndex = (
                    P.selectpicker.current.data[L] || {}
                  ).index),
                  P.focusItem(A);
              }
          ...
          l(i, !0),
            ...
            z(window)
              ...
              .on(
                ...
                function () {
                  P.$newElement.hasClass(V.SHOW) &&
                    l(P.$menuInner[0].scrollTop);
                }
              );
        },
        ...
        render: function () {
          ...
          var e,
            ...
            d = !1;
          if (
            (r.classList.toggle("bs-placeholder", i.multiple ? !o : !T(s, n)),
            this.tabIndex(),
            "static" === this.options.selectedTextFormat)
          )
            c = Z({ text: this.options.title }, !0);
          else if (
            ((e =
              this.multiple &&
          ...
          if (
            ...
            this.options.sanitize &&
              d &&
              B([c], i.options.whiteList, i.options.sanitizeFn),
            (l.innerHTML = ""),
            l.appendChild(c),
            R.major < 4 &&
        ...
        keydown: function (e) {
          ...
          if (
            ...
            i &&
              ((e.which === H && !a.selectpicker.keydown.keyHistory) ||
                e.which === D ||
                (e.which === P && a.options.selectOnTab)) &&
