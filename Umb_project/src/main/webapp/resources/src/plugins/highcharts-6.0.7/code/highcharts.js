...
(function (S, K) {
        ...
        function t(a) {
          ...
          for (e = a.length; e--; )
            (c = "M" === a[e] || "L" === a[e]),
              ...
              c &&
                h &&
                a.splice(e + 1, 0, a[e + 1], a[e + 2], a[e + 1], a[e + 2]);
        }
        function n(a, c) {
          for (; a.length < h; ) {
            a[0] = c[h - a.length];
  ...
  (function (a) {
    ...
    h(B.prototype, {
      ...
      align: function (a, g, c) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = g), !c || C(c))
          )
      ...
      getBBox: function (a, g) {
        ...
        if (!y) {
          ...
          w.isSVG &&
            ...
            g &&
              ((y.width =
                Math.abs(w * Math.sin(b)) + Math.abs(a * Math.cos(b))),
              (y.height =
                Math.abs(w * Math.cos(b)) + Math.abs(a * Math.sin(b)))));
          if (F && 0 < y.height) {
      ...
      zIndexSetter: function (a, c) {
        ...
        var p;
        u(a) &&
          ((b.zIndex = a), (a = +a), this[c] === a && (e = !1), (this[c] = a));
        if (e) {
      ...
      buildText: function (a) {
        var c = a.element,
          ...
          R = function (a) {
            ...
            return l
              ? g(l)
              : w.fontMetrics(h, a.getAttribute("style") ? a : c).h;
          },
          q = function (a, g) {
      ...
      symbol: function (a, g, c, w, b, e) {
        var k = this,
          ...
          F =
            u(g) &&
            A &&
            A.call(this.symbols, Math.round(g), Math.round(c), w, b, e),
          r,
          L;
        A
          ? ((p = this.path(F)),
      ...
      label: function (g, c, b, e, k, p, x, N, m) {
        ...
        q = function () {
          var a = y.element.style,
            g = {};
          P =
            (void 0 === n || void 0 === D || C) && u(y.textStr) && y.getBBox();
        ...
        if (B(v)) {
          ...
          e >= l.hour &&
            b.set(
              "Hours",
              k,
              e >= l.day ? 0 : p * Math.floor(b.get("Hours", k) / p)
            );
          e >= l.day &&
            b.set(
              "Date",
              k,
              e >= l.month ? 1 : p * Math.floor(b.get("Date", k) / p)
            );
          e >= l.month &&
            (b.set(
              "Month",
              k,
              e >= l.year ? 0 : p * Math.floor(b.get("Month", k) / p)
            ),
            (h = b.get("FullYear", k)));
          e >= l.year && b.set("FullYear", k, h - (h % p));
          e === l.week &&
            b.set("Date", k, b.get("Date", k) - b.get("Day", k) + f(c, 1));
          h = b.get("FullYear", k);
          c = b.get("Month", k);
          var n = b.get("Date", k),
            z = b.get("Hours", k);
  ...
  var V = (function (a) {
    ...
    a.extend(G.prototype, {
      ...
      init: function (a, c) {
        ...
        b.side =
          c.side || (b.horiz ? (b.opposite ? 0 : 2) : b.opposite ? 1 : 3);
        b.setOptions(c);
        var w = this.options,
          d = w.type;
        ...
        if (x && x / e < a.len / 3)
          if (a.isLog)
            c(this.paddedTicks, function (g, c, b) {
              c &&
                h.push.apply(h, a.getLogTickPositions(e, b[c - 1], b[c], !0));
            });
      ...
      unsquish: function () {
        ...
        b
          ? (A =
              ...
              (n(p)
                ? [p]
                : h < C(a.autoRotationLimit, 80) && a.autoRotation)) &&
            c(A, function (a) {
              var b;
              if (a === p || (a && -90 <= a && 90 >= a))
      ...
      renderUnsquish: function () {
        ...
        r.rotation &&
          ...
          A || (l = "ellipsis"));
        if (
          (this.labelAlign = h.align || this.autoLabelAlign(this.labelRotation))
        )
      ...
      getOffset: function () {
        ...
        a.axisGroup ||
          ...
          (a.labelGroup = d
            ...
            .addClass(
              "highcharts-" + a.coll.toLowerCase() + "-labels " + (v || "")
            )
            .add(M)));
        m || a.isLinked
          ? (c(h, function (b, c) {
  ...
  (function (a) {
    ...
    a.Tooltip.prototype = {
          ...
          !1 === p
            ...
            : ((c = this.getLabel()),
              ...
              this.split
                ...
                : (d.style.width ||
                    c.css({ width: this.chart.spacingBox.width }),
                  c.attr({ text: p && p.join ? p.join("") : p }),
                  c
                    .removeClass(/highcharts-color-[\d]+/g)
                    .addClass(
                      "highcharts-color-" + t(k.colorIndex, f.colorIndex)
                    ),
                  c.attr({
      ...
      getXDateFormat: function (a, b, m) {
        ...
        return (
          (c ? this.getDateFormat(c, a.x, m.options.startOfWeek, b) : b.day) ||
          b.year
        );
      },
        ...
        (n && n.touch) ||
          ...
          10 < this.hasDragged &&
            ...
            n &&
              h &&
              ((d -= g),
              n.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + g })),
            n &&
              k &&
              ((d = e - w),
              n.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + w })),
    ...
    E(a.Pointer.prototype, {
      ...
      pinch: function (a) {
        ...
        "touchstart" === a.type
          ...
          : u.length &&
            (h ||
              (n.selectionMarker = h = E({ destroy: f, touch: !0 }, t.plotBox)),
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
      ...
      renderItem: function (a) {
        ...
        z.width ||
          G.css({ width: (d.itemWidth || d.width || b.spacingBox.width) - t });
        this.setText(a);
        c = G.getBBox();
        ...
        animate: function (a) {
          ...
          a
            ...
            : ((e = this.sharedClipKey),
              ...
              b[e + "m"] &&
                b[e + "m"].animate({ width: b.plotSizeX + 99, x: 0 }, c),
              (this.animate = null));
        },
                  ...
                  ? ((d = r(k.symbol, this.symbol)),
                    ...
                    g
                      ...
                      : m &&
                        ...
                        (e.graphic = g =
                          b.renderer
                            .symbol(d, p.x, p.y, p.width, p.height, f ? k : h)
                            .add(l)),
      ...
      if (
        ...
        for (G = 0; G < d; G++)
          (g = c[G]),
            ...
            null !== w &&
              (A.points[J].push(A.cumulative), (f[G] = A.cumulative));
  ...
  (function (a) {
    ...
    v(E.prototype, {
      ...
      remove: function (a) {
        for (
          var b = this.chart, c = this.coll, h = this.series, k = h.length;
          k--;
      ...
      },
      {
        ...
        pointAttribs: function (a, b) {
          ...
          b &&
            ...
            (e =
              a.color ||
              (void 0 !== b && H(e).brighten(a.brightness).get()) ||
              e),
            (p = a[d] || p),
            (n = a[f] || n),
            (h = a.dashStyle || h));
      ...
      },
      {
        ...
        translate: function (a) {
          ...
          this.getX = function (b, c, e) {
            n = Math.asin(
              Math.min((b - a[1]) / (a[2] / 2 + e.labelDistance), 1)
            );
            return (
              a[0] + (c ? -1 : 1) * Math.cos(n) * (a[2] / 2 + e.labelDistance)
            );
          };
          for (A = 0; A < B; A++) {
            G = u[A];
        ...
        haloPath: function (a) {
          ...
          return this.sliced || !this.visible
            ...
            : this.series.chart.renderer.symbols.arc(
                ...
                b.r + a,
                b.r + a,
                { innerR: this.shapeArgs.r - 1, start: b.start, end: b.end }
              );
        },
      }
    );
  ...
  (function (a) {
    ...
    b.prototype.justifyDataLabel = function (a, b, c, d, f, l) {
      ...
      m = c.y + p;
      0 > m &&
        ("bottom" === k ? (b.verticalAlign = "top") : (b.y = -m), (n = !0));
      m = c.y + d.height - p;
      m > e.plotHeight &&
        ("top" === k ? (b.verticalAlign = "bottom") : (b.y = e.plotHeight - m),
        (n = !0));
      ...
      for (n = 0; n < f; n++)
        if ((q = a[n]))
          (q.oldOpacity = q.opacity),
            (q.newOpacity = 1),
            q.width ||
              ((v = q.getBBox()), (q.width = v.width), (q.height = v.height));
      a.sort(function (a, b) {
      ...
      setState: function (a, b) {
        ...
        if (
          ...
          (c = f.halo) && c.size
            ? (u ||
                (e.halo = u =
                  t.renderer.path().add((this.graphic || q).parentGroup)),
