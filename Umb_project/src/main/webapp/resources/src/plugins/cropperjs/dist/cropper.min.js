...
!(function (t, i) {
  ...
  var t = "undefined" != typeof window ? window : {},
    ...
    H = "dblclick",
    N = "load",
    E = t.PointerEvent ? "pointerdown" : "touchstart mousedown",
  ...
  function V(t) {
    return "object" === (void 0 === t ? "undefined" : j(t)) && null !== t;
  }
  ...
  function J(t) {
    ...
    try {
      var i = t.constructor,
        e = i.prototype;
      return i && e && G.call(e, "isPrototypeOf");
    } catch (t) {
      return !1;
    }
  }
  ...
  function tt(t, i) {
    if (t && _(i))
      if (Array.isArray(t) || F(t.length)) {
        var e = t.length,
          a = void 0;
        for (a = 0; a < e && !1 !== i.call(t, t[a], a, t); a += 1);
      } else
        V(t) &&
  ...
  function mt(t, i) {
    ...
    else t.removeAttribute("data-" + ct(i));
  }
  var gt = /\s\s*/;
  function ut(t, i, e) {
    var a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
    tt(i.trim().split(gt), function (i) {
      t.removeEventListener(i, e, a);
    });
  }
  function ft(t, i, e) {
    var a = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
    if (a.once) {
      var n = e;
      e = function () {
        for (var o = arguments.length, h = Array(o), r = 0; r < o; r++)
          h[r] = arguments[r];
        return ut(t, i, e, a), n.apply(t, h);
      };
    }
    tt(i.trim().split(gt), function (i) {
      t.addEventListener(i, e, a);
    });
  }
  function vt(t, i, e) {
    var a = void 0;
  ...
  function yt(t) {
    var i = t.match(bt);
    return (
      i && (i[1] !== xt.protocol || i[2] !== xt.hostname || i[3] !== xt.port)
    );
  }
  function Mt(t) {
  ...
  function Ct(t) {
    var i = t.rotate,
      ...
      o = t.translateY,
      h = [];
    F(n) && 0 !== n && h.push("translateX(" + n + "px)"),
      F(o) && 0 !== o && h.push("translateY(" + o + "px)"),
      F(i) && 0 !== i && h.push("rotate(" + i + "deg)"),
      F(e) && 1 !== e && h.push("scaleX(" + e + ")"),
      F(a) && 1 !== a && h.push("scaleY(" + a + ")");
  ...
  var Bt = Number.isFinite || t.isFinite;
  function kt(t) {
    var i = t.aspectRatio,
      e = t.height,
      a = t.width,
    ...
    if (n) {
      ...
      if (
        ...
        (function (t, i, e) {
          var a = "",
            n = void 0;
          for (e += i, n = i; n < e; n += 1) a += Tt(t.getUint8(n));
          return a;
        })(i, n + 4, 4)
      ) {
        var d = i.getUint16(s);
  ...
  var Nt = {
      ...
      initContainer: function () {
        ...
        (this.containerData = n),
          ot(a, { width: n.width, height: n.height }),
          ht(t, f),
          rt(a, f);
      },
      initCanvas: function () {
        ...
        if (t) {
          ...
          h > 1
            ? ((d = Math.max(d, a.width)),
              ...
              3 === h && (c * r > d ? (d = c * r) : (c = d / r)))
            : h > 0 &&
              (d
                ? (d = Math.max(d, s ? o.width : 0))
                : c
                ? (c = Math.max(c, s ? o.height : 0))
                : s &&
                  ((d = o.width),
                  (c = o.height) * r > d ? (d = c * r) : (c = d / r)));
          var l = kt({ aspectRatio: r, width: d, height: c });
          (d = l.width),
            (c = l.height),
            (n.minWidth = d),
            (n.minHeight = c),
        ...
        (e.width > e.maxWidth || e.width < e.minWidth) && (e.left = e.oldLeft),
          ...
          ot(
            ...
            it(
              ...
              Ct({ translateX: e.left, translateY: e.top })
            )
          ),
          this.renderImage(t),
      ...
      renderImage: function (t) {
        ...
        it(e, {
          ...
          ot(
            ...
            it(
              { width: e.width, height: e.height },
              Ct(it({ translateX: e.left, translateY: e.top }, e))
            )
          ),
          t && this.output();
      },
          ...
          (s = Math.min(s, a.width)),
            ...
            r &&
              (s && d
                ...
                : d && (s = d * r),
              l * r > c ? (l = c / r) : (c = l * r)),
            (o.minWidth = Math.min(s, c)),
            (o.minHeight = Math.min(d, l)),
            (o.maxWidth = c),
            (o.maxHeight = l);
        }
        i &&
        ...
        (a.width > a.maxWidth || a.width < a.minWidth) && (a.left = a.oldLeft),
          ...
          t.movable &&
            ...
            pt(
              this.face,
              b,
              a.width >= i.width && a.height >= i.height ? n : e
            ),
          ot(
            this.cropBox,
            it(
              { width: a.width, height: a.height },
              Ct({ translateX: a.left, translateY: a.top })
            )
          ),
      ...
      output: function () {
        this.preview(), vt(this.element, B, this.getData());
      },
    },
    Et = {
      initPreview: function () {
        ...
        if (
          ...
          var n = i;
          "string" == typeof i
            ? (n = this.element.ownerDocument.querySelectorAll(i))
            : i.querySelector && (n = [i]),
            (this.previews = n),
            tt(n, function (i) {
      ...
      preview: function () {
        ...
        this.cropped &&
          ...
          (ot(
            ...
            it(
              { width: o, height: h },
              Ct(it({ translateX: -r, translateY: -s }, t))
            )
          ),
          tt(this.previews, function (i) {
            var e = lt(i, y),
              d = e.width,
              c = e.height,
              l = d,
            ...
            a && (p = n * (m = d / a)),
              n && p > c && ((l = a * (m = c / n)), (p = c)),
              ot(i, { width: l, height: p }),
              ot(
                i.getElementsByTagName("img")[0],
                it(
                  { width: o * m, height: h * m },
                  Ct(it({ translateX: -r * m, translateY: -s * m }, t))
                )
              );
          }));
      },
    ...
    zt = {
      bind: function () {
        var t = this.element,
          i = this.options,
          e = this.cropper;
        _(i.cropstart) && ft(t, W, i.cropstart),
          _(i.cropmove) && ft(t, T, i.cropmove),
          _(i.cropend) && ft(t, k, i.cropend),
          _(i.crop) && ft(t, B, i.crop),
          _(i.zoom) && ft(t, R, i.zoom),
          ft(e, E, (this.onCropStart = this.cropStart.bind(this))),
          i.zoomable &&
            i.zoomOnWheel &&
            ft(e, O, (this.onWheel = this.wheel.bind(this))),
          i.toggleDragModeOnDblclick &&
            ft(e, H, (this.onDblclick = this.dblclick.bind(this))),
          ft(t.ownerDocument, z, (this.onCropMove = this.cropMove.bind(this))),
          ft(t.ownerDocument, L, (this.onCropEnd = this.cropEnd.bind(this))),
          i.responsive &&
            ft(window, X, (this.onResize = this.resize.bind(this)));
      },
      unbind: function () {
        var t = this.element,
          i = this.options,
          e = this.cropper;
        _(i.cropstart) && ut(t, W, i.cropstart),
          _(i.cropmove) && ut(t, T, i.cropmove),
          _(i.cropend) && ut(t, k, i.cropend),
          _(i.crop) && ut(t, B, i.crop),
          _(i.zoom) && ut(t, R, i.zoom),
          ut(e, E, this.onCropStart),
          i.zoomable && i.zoomOnWheel && ut(e, O, this.onWheel),
          i.toggleDragModeOnDblclick && ut(e, H, this.onDblclick),
          ut(t.ownerDocument, z, this.onCropMove),
          ut(t.ownerDocument, L, this.onCropEnd),
          i.responsive && ut(window, X, this.onResize);
      },
    },
    Lt = {
      resize: function () {
      ...
      cropStart: function (t) {
        if (!this.disabled) {
          ...
          t.changedTouches
            ...
            (n =
              Object.keys(e).length > 1 && i.zoomable && i.zoomOnTouch
                ? o
                : lt(t.target, b)),
            S.test(n) &&
              !1 !== vt(this.element, W, { originalEvent: t, action: n }) &&
              (t.preventDefault(),
              (this.action = n),
              (this.cropping = !1),
              n === a && ((this.cropping = !0), ht(this.dragBox, w)));
        }
      },
      cropMove: function (t) {
        var i = this.action;
        if (!this.disabled && i) {
          var e = this.pointers;
          t.preventDefault(),
            !1 !== vt(this.element, T, { originalEvent: t, action: i }) &&
              (t.changedTouches
                ? tt(t.changedTouches, function (t) {
                    it(e[t.identifier], Dt(t, !0));
                  })
                : it(e[t.pointerId || 0], Dt(t, !0)),
              this.change(t));
        }
      },
      cropEnd: function (t) {
        if (!this.disabled) {
          ...
          t.changedTouches
            ...
            i &&
              ...
              this.cropping &&
                ((this.cropping = !1),
                st(this.dragBox, w, this.cropped && this.options.modal)),
              vt(this.element, k, { originalEvent: t, action: i }));
        }
      },
    },
    Yt = {
      change: function (t) {
        var i = this.options,
          ...
          E = !0,
          z = void 0;
        !b && t.shiftKey && (b = C && D ? C / D : 1),
          this.limited &&
            ((T = v.minLeft),
            (W = v.minTop),
            (H = T + Math.min(u.width, g.width, g.left + g.width)),
            (N = W + Math.min(u.height, g.height, g.top + g.height)));
        var L,
          Y,
          X,
          O = w[Object.keys(w)[0]],
          R = { x: O.endX - O.startX, y: O.endY - O.startY },
          S = function (t) {
            switch (t) {
              case h:
                B + R.x > H && (R.x = H - B);
          ...
          case o:
            this.zoom(
              ...
              tt(L, function (t, i) {
                delete Y[i],
                  tt(Y, function (i) {
                    var e = Math.abs(t.startX - i.startX),
                      a = Math.abs(t.startY - i.startY),
                      n = Math.abs(t.endX - i.endX),
                      o = Math.abs(t.endY - i.endY),
                      h = Math.sqrt(e * e + a * a),
                      r = (Math.sqrt(n * n + o * o) - h) / h;
                    X.push(r);
                  });
              }),
              X.sort(function (t, i) {
    ...
    Xt = {
      crop: function () {
        return (
          !this.ready ||
            ...
            ((this.cropped = !0),
            this.limitCropBox(!0, !0),
            this.options.modal && ht(this.dragBox, w),
            rt(this.cropBox, f),
      ...
      enable: function () {
        return (
          this.ready &&
            this.disabled &&
            ((this.disabled = !1), rt(this.cropper, u)),
          this
        );
      },
      disable: function () {
        return (
          this.ready &&
            !this.disabled &&
            ((this.disabled = !0), ht(this.cropper, u)),
          this
        );
      },
      destroy: function () {
        ...
        if (
          ...
          if (e) {
            ...
            (r.left -= (p - s) * ((f.pageX - u.left - r.left) / s)),
              (r.top -= (m - d) * ((f.pageY - u.top - r.top) / d));
          } else
            J(i) && F(i.x) && F(i.y)
              ? ((r.left -= (p - s) * ((i.x - r.left) / s)),
                (r.top -= (m - d) * ((i.y - r.top) / d)))
              : ((r.left -= (p - s) / 2), (r.top -= (m - d) / 2));
      ...
      getData: function () {
        ...
        return (
          i.rotatable && (o.rotate = e.rotate || 0),
          i.scalable &&
            ((o.scaleX = e.scaleX || 1), (o.scaleY = e.scaleY || 1)),
          o
        );
      },
      setData: function (t) {
      ...
      getCroppedCanvas: function () {
        ...
        var i,
          ...
          A =
            ...
            (E = N.getContext("2d")),
            (z = kt({ aspectRatio: m, width: C, height: B })),
            (L = kt({ aspectRatio: m, width: T, height: H }, "cover")),
            (Y = Math.min(z.width, Math.max(L.width, g))),
            (X = Math.min(z.height, Math.max(L.height, u))),
            (O = Math.min(z.width, Math.max(L.width, o))),
            (R = Math.min(z.height, Math.max(L.height, h))),
            (S = [-O / 2, -R / 2, O, R]),
            (N.width = at(Y)),
            (N.height = at(X)),
            (E.fillStyle = v),
            ...
            E.save(),
            E.translate(Y / 2, X / 2),
            E.rotate((s * Math.PI) / 180),
            E.scale(c, p),
            (E.imageSmoothingEnabled = x),
            (E.imageSmoothingQuality = y),
            E.drawImage.apply(
              E,
              [i].concat(
                Q(
        ...
        var U = this.getData(),
          ...
          q = U.width,
          $ = U.height,
          Z = A.width / Math.floor(I.naturalWidth);
        1 !== Z && ((P *= Z), (j *= Z), (q *= Z), ($ *= Z));
        var F = q / $,
          K = kt({
            aspectRatio: F,
          ...
          G = kt({
            aspectRatio: F,
            width: t.width || (1 !== Z ? A.width : q),
            height: t.height || (1 !== Z ? A.height : $),
          }),
          J = G.width,
          _ = G.height;
        (J = Math.min(K.width, Math.max(V.width, J))),
          (_ = Math.min(K.height, Math.max(V.height, _)));
        var tt = document.createElement("canvas"),
          it = tt.getContext("2d");
        (tt.width = at(J)),
          (tt.height = at(_)),
          (it.fillStyle = t.fillColor || "transparent"),
          it.fillRect(0, 0, J, _);
        var et = t.imageSmoothingEnabled,
          nt = void 0 === et || et,
          ot = t.imageSmoothingQuality;
        (it.imageSmoothingEnabled = nt), ot && (it.imageSmoothingQuality = ot);
        var ht = A.width,
          rt = A.height,
          st = P,
          dt = j,
        ...
        st <= -q || st > ht
          ? ((st = 0), (ct = 0), (pt = 0), (gt = 0))
          : st <= 0
          ? ((pt = -st), (st = 0), (gt = ct = Math.min(ht, q + st)))
          : st <= ht && ((pt = 0), (gt = ct = Math.min(q, ht - st))),
          ct <= 0 || dt <= -$ || dt > rt
            ? ((dt = 0), (lt = 0), (mt = 0), (ut = 0))
            : dt <= 0
            ? ((mt = -dt), (dt = 0), (ut = lt = Math.min(rt, $ + dt)))
            : dt <= rt && ((mt = 0), (ut = lt = Math.min($, rt - dt)));
        var ft = [st, dt, ct, lt];
        if (gt > 0 && ut > 0) {
          var vt = J / q;
          ft.push(pt * vt, mt * vt, gt * vt, ut * vt);
        }
        return (
          it.drawImage.apply(
            it,
      ...
      setDragMode: function (t) {
        ...
        if (this.ready && !this.disabled) {
          ...
          (t = n || o ? t : D),
            ...
            st(e, g, n),
            st(e, x, o),
            i.cropBoxMovable || (pt(a, b, t), st(a, g, n), st(a, x, o));
        }
        return this;
      },
    },
        ...
        $(
          ...
          [
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (h > 1) {
                  ...
                  (r = c.rotate), (s = c.scaleX), (d = c.scaleY);
                }
                n.rotatable && (o.rotate = r),
                  n.scalable && ((o.scaleX = s), (o.scaleY = d)),
                  this.clone();
              },
            },
            {
            ...
            },
            {
              ...
              value: function (i) {
                var e = this,
                  a = this.isImg ? this.element : this.image;
                i && ((a.onload = null), (a.onerror = null)),
                  (this.sizing = !0);
                var n =
                    t.navigator &&
                ...
                if (!a.naturalWidth || n) {
                  ...
                  (this.sizingImage = h),
                    (h.onload = function () {
                      o(h.width, h.height), n || r.removeChild(h);
                    }),
                    (h.src = a.src),
                    n ||
                      ((h.style.cssText =
                      ...
                      r.appendChild(h));
                } else o(a.naturalWidth, a.naturalHeight);
              },
            },
            {
              key: "stop",
            ...
            },
            {
              ...
              value: function () {
                if (this.sized && !this.ready) {
                  ...
                  var r = h.querySelector("." + i + "-container"),
                    s = r.querySelector("." + i + "-canvas"),
                    d = r.querySelector("." + i + "-drag-box"),
                    c = r.querySelector("." + i + "-crop-box"),
                    l = c.querySelector("." + i + "-face");
                  (this.container = o),
                    (this.cropper = r),
                    (this.canvas = s),
                    (this.dragBox = d),
                    (this.cropBox = c),
                    (this.viewBox = r.querySelector("." + i + "-view-box")),
                    (this.face = l),
                    s.appendChild(n),
                    ht(t, f),
                    ...
                    ht(c, f),
                    a.guides || ht(c.getElementsByClassName(i + "-dashed"), f),
                    a.center || ht(c.getElementsByClassName(i + "-center"), f),
                    a.background && ht(r, i + "-bg"),
                    a.highlight || ht(l, "cropper-invisible"),
                    a.cropBoxMovable && (ht(l, x), pt(l, b, e)),
                    a.cropBoxResizable ||
                      (ht(c.getElementsByClassName(i + "-line"), f),
                      ht(c.getElementsByClassName(i + "-point"), f)),
                    this.render(),
                    (this.ready = !0),
                    this.setDragMode(a.dragMode),
                    a.autoCrop && this.crop(),
                    this.setData(a.data),
                    _(a.ready) && ft(t, Y, a.ready, { once: !0 }),
                    vt(t, Y);
                }
              },
            },
  ...
  return it(Rt.prototype, Nt, Et, zt, Lt, Yt, Xt), Rt;
});
