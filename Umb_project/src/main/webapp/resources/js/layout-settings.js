(function() {
	...
	$(document).ready(function() {
		...
		var bgcolor_dark = jQuery('.bgcolor-dark');
		var bgcolor_light = jQuery('.bgcolor-light');

		bgcolor_dark.click(function() {
			'use strict';
			jQuery(this).addClass('active');
			bgcolor_light.removeClass('active');
			body.removeClass('bgcolor-light').addClass('bgcolor-dark');

			//Store in local storage
			setOptions("backgroundColor", "bgcolor-dark")
		});

		//Click for current options
		if (currentOptions.backgroundColor === "bgcolor-dark") {
			bgcolor_dark.trigger("click");
		}

		bgcolor_light.click(function() {
			'use strict';
			jQuery(this).addClass('active');
			bgcolor_dark.removeClass('active');
			body.removeClass('bgcolor-dark').addClass('bgcolor-light');

			//Store in local storage
			setOptions("backgroundColor", "bgcolor-light")
		});

		//Click for current options
		if (currentOptions.backgroundColor === "bgcolor-light") {
			bgcolor_light.trigger("click")
		}
