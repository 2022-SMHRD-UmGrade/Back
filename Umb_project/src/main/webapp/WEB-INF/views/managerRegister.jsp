...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/src/plugins/jquery-steps/jquery.steps.css">
...
<body>
							...
							<ul>
								<li>
									<a href="#" class="alert alert-dismissible fade show" role="alert">
										<img src="resources/images/kuromi1.jpg" alt="">
										<h3>💜</h3>
										<p>빛을 잃어가는 마음과는 달리</p>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">관리자등록</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30 col-md-10 offset-md-1">
					<div class="clearfix col-md-10 offset-md-1">
						<div class="pull-left">
							<h4 data-color="#A3CBE6">관리자등록</h4>
							<br>
						</div>
					</div>
					<form class="col-md-10 offset-md-1">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">비밀번호확인</label>
							<div class="col-sm-12 col-md-8">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-8">
								<input class="form-control" type="email" placeholder="test@example.com">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-8">
								<input class="form-control date-picker" placeholder="생년월일" type="text">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">회원유형</label>
							<div class="col-sm-12 col-md-8">
						...
						<div class="form-grid-form" style="text-align: center">
							<input class="btn btn-outline-custom" type="submit" value="등록">
						</div>
					</form>
				</div>
	...
	<script src="${path}/resources/src/plugins/jquery-steps/jquery.steps.js"></script>
	<script src="${path}/resources/js/steps-setting.js"></script>
</body>
</html>