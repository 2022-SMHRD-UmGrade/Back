...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${path}/resources/src/plugins/fullcalendar/fullcalendar.css">
...
<body>	
						...
						<div class="col-md-12 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">달력</li>
								</ol>
							</nav>
						</div>
					</div>
	...
	<script src="${path}/resources/src/plugins/fullcalendar/fullcalendar.min.js"></script>
	<script src="${path}/resources/js/calendar-setting.js"></script>
</body>
</html>