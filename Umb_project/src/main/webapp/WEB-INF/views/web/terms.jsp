...
<html lang="en">
  ...
  <body>
<h2>위치기반서비스 이용약관</h2><br>
<h3>제1조 (목적)</h3>
<p>본 약관은 회원(본 약관에 동의한 자를 말합니다. 이하 “회원”이라고 합니다)이 UM-GRADE(이하 “회사”라고 합니다)가 제공하는 위치기반서비스(이하 “서비스”라고 합니다)를 이용함에 있어 회사와 회원의 권리•의무 및 책임사항을 규정함을 목적으로 합니다.
</p>
<br>
...
<br>
<h3>제3조 (약관 외 준칙)</h3>
<p>본 약관에 규정되지 않은 사항에 대해서는 위치정보의 보호 및 이용 등에 관한 법률(이하 “위치정보법”이라고 합니다), 전기통신사업법, 정보통신망 이용촉진 및 보호 등에 관한 법률(이하 “정보통신망법”이라고 합니다), 개인정보보호법 등 관련법령 또는 회사가 정한 서비스의 운영정책 및 규칙 등(이하 “세부지침”이라고 합니다)의 규정에 따르며, 개인정보 처리기준 및 보호조치 등에 관한 사항은 개인정보 처리방침을 통해 공개합니다.
</p>
<br>
<h3>제4조 (서비스의 가입)</h3>
...
<h3>제5조 (서비스의 해지)</h3>
<p>
    회원이 서비스 이용을 해지하고자 할 경우 회원은 회사가 정한 절차(애플리케이션 페이지 등을 통해 공지합니다)를 통해 서비스 해지를 신청할 수 있으며, 회사는 법령이 정하는 바에 따라 신속히 처리합니다.
</p>
<br>
<h3>
    제6조 (서비스의 내용)
...
<ol>
    ...
    <li>
        회사가 제공하는 서비스의 종류, 세부 내용, 이용 요금은 ‘별표1. 위치기반서비스의 종류 및 요금’에 따릅니다.
    </li>
</ol>
<br>
<h3>
...
<ol>
    ...
    <li>
        회원 및 법정대리인의 권리와 그 행사방법은 제소 당시의 이용자의 주소에 의하며, 주소가 없는 경우에는 거소를 관할하는 지방법원의 전속관할로 합니다. 다만, 제소 당시 이용자의 주소 또는 거소가 분명하지 않거나 외국 거주자의 경우에는 여 관할법원에 제기합니다.
    </li>
    <li>
...
<br>
<h3>
    제11조 (개인위치정보의 보유목적 및 보유기간)
</h3>
<ol>
    <li>
        회사는 위치기반서비스를 제공하기 위해 필요한 최소한의 개인위치정보를 보유 및 이용하며, 개인위치정보의 보유목적은 ‘별표1. 위치기반서비스의 종류 및 요금’에 따릅니다.
    </li>
    <li>
        회사는 회원의 개인위치정보를 이용한 경우 위치정보법에 의하여 기록·보존하여야 하는 위치정보 이용·제공사실 확인자료 외에 해당 개인위치정보를 회원 탈퇴 및 서비스 종료 시 지체 없이 파기합니다. 단, 관련 법령에 의한 보관이 필요한 경우 해당 기간만큼 보관합니다.
    </li>
</ol>
<br>
<h3>
...
<ol>
    <li>
        회사는 14세 미만의 회원에 대해서는 개인위치정보를 이용한 위치기반서비스 제공 및 개인위치정보의 제3자 제공에 대한 동의를 당해 회원과 당해 회원의 법정대리인으로부터 동의를 받아야 합니다. 이 경우 법정대리인은 제12조에 의한 회원의 권리를 모두 가집니다.
    </li>
    <li>
...
<ol>
    <li>
        회사는 아래의 경우에 해당하는 자(이하 “8세 이하의 아동 등”이라고 합니다)의 보호의무자가 8세 이하의 아동 등의 생명 또는 신체보호를 위하여 개인위치정보의 이용 또는 제공에 동의하는 경우에는 본인의 동의가 있는 것으로 봅니다.
        <ol>
            <li>
                8세 이하의 아동
            </li>
...
<p>
    <a href="privacy">[별표1] 위치기반 서비스의 종류 및 요금</a><br>
</p>
  </body>
</html>
