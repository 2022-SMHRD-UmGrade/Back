			...
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="qna.jsp">질의응답</a></li>
				...
				<div class="pd-20 card-box mb-30 col-md-10 offset-md-1">
					<div class="clearfix col-md-10 offset-md-1">
						<div class="pull-left">
							<h4 data-color="#A3CBE6">응답순번</h4>
							<p class="mb-30">질의순번</p>
						</div>
					</div>
					<form class="col-md-10 offset-md-1">
						...
						<div class="form-group">
							<input type="submit" class="btn btn-outline-custom" value="보내기">
						</div>					
					</form>
				</div>
